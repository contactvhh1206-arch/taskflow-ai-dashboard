...
def replace_endpoint(content, start_str, new_code):
...
content = replace_endpoint(content, "app.patch('/api/tasks/:id/restore',", api_restore)
content = replace_endpoint(content, "app.put('/api/tasks/:id/status',", api_status)
content = replace_endpoint(content, "app.put('/api/tasks/:id/support',", api_support)
content = replace_endpoint(content, "app.post('/api/tasks/:id/comments',", api_comments)
content = replace_endpoint(content, "app.post('/api/tasks',", api_tasks_post)
