...
target_start_str = "// Lấy user_id an toàn tuyệt đối (Không bao giờ văng 500)"
target_end_str = "        console.error(\"Lỗi parse user an toàn:\", parseErr);\n    }"
...
if start_idx != -1 and end_idx != -1:
    ...
    replacement = """// Lấy user_id an toàn (Linh hoạt tự động tìm User hợp lệ)
    let realUserId = null;
    try {
