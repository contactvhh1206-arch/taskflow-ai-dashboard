...
5. **Ngày ghi 0 đồng là dấu hiệu THIẾU BÁO CÁO, không phải nghỉ bán.** Nếu khối dữ liệu có mục **[CẢNH BÁO THIẾU SỐ LIỆU]**: bắt buộc nêu thẳng những ngày đó trong câu trả lời, và khi so sánh giữa các kỳ phải đưa thêm con số sau khi loại các ngày rỗng ra khỏi mẫu số — vì vài ngày rỗng cuối tháng đủ sức lật ngược kết luận tăng thành giảm. Không tự ý xoá chúng khỏi bảng, chỉ nói rõ ảnh hưởng.
