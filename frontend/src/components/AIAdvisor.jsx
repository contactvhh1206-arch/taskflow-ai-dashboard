        ...
        {chatLog.length === 0 && !isFacilityMode && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none p-6">
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6 pointer-events-auto">
              <div onClick={() => handleAsk('Báo cáo tổng quan toàn bộ 6 cơ sở: doanh thu tháng này đạt bao nhiêu so với chỉ tiêu KPI, cơ sở nào tốt nhất và cơ sở nào yếu nhất? Tình hình vận hành, chuyên cần nhân viên và tiến độ công việc có vấn đề gì cần xử lý ngay không? Đề xuất hành động cụ thể.')} className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-8 rounded-3xl border border-blue-100 dark:border-blue-800/50 cursor-pointer hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden">
              ...
              <div onClick={() => handleAsk('Rà soát tiến độ công việc và hiệu suất KPI của tất cả phòng ban hiện tại. Phòng ban nào đang trễ task, chưa làm? Phòng ban nào đạt chỉ tiêu, phòng ban nào chưa? Chỉ ra điểm nghẽn và đề xuất giải pháp xử lý.')} className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-8 rounded-3xl border border-purple-100 dark:border-purple-800/50 cursor-pointer hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden">
